...
def train_net(data, model, loss_func, optimizer, batch_size, max_epochs,
    ...
    for epoch in range(max_epochs):
        ...
        for iter in tqdm(range(iter_start, iter_end)):
            ...
            #############################################################################
            act = model.forward(data_batch)
            loss = loss_func.forward(act, labels_batch)
#             print(loss)
            loss_derivative = loss_func.backward()
#             print(loss_derivative)
            grads = model.backward(loss_derivative, regularization, reg_lambda)
    #             print(gradient)
            optimizer.step()
